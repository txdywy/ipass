...
- iStoreOS 24.10.x
- OpenWrt 24.10 SDK
- CI build targets: `armsr-armv8` and `x86-64`
...
The build workflow runs on `main` branch pushes, `v*` tag pushes, and manual dispatch. It builds with ARM and x86 OpenWrt 24.10 SDK targets and uploads both `.ipk` and self-installing `.run` artifacts.
